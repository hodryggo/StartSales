...
<head>
    ...
    <!-- Titulo da Pagina -->
    <title>Cadastro de Finalizadoras</title>
...
<?php
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT -->
               <form action="php/insertfina.php" method="POST">
                                ...
                                <div style="float:left;width:900px;height:100px;">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Cadastro de Finalizadora</strong>
                                        ...
                                        <div class="card-body card-block">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" id="nome" name="nome" placeholder="Informe o nome da finalizadora" class="form-control">
                                                    </div>
                                                    <div class="form-group">
