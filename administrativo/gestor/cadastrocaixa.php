...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT -->
               <form action="php/insertcaixa.php" method="POST">
                                ...
                                <div style="float:left;width:900px;height:100px;">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Cadastro de Caixas</strong>
                                        ...
                                        <div class="card-body card-block">
                                                ...
                                                <div class="form-group">
                                                        <label for="company" class=" form-control-label">Número do caixa</label>
                                                        <input type="text" id="numero" name="numero" placeholder="Informe o número do caixa" class="form-control">
                                                    </div>
                                                    <div class="form-group">
