    ...
    <div class="page-wrapper">
      ...
      <?php
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <form action="php/insertestab.php" method="POST">
                        ...
                        <div style="float:left;width:900px;height:100px;">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Cadastro de Estabelecimento</strong>
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="cpfcnpj" name="cpf" placeholder="Informe seu CPF ou CNPJ" class="form-control">
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-8">
                                            <div class="form-group">
                                                <label for="city" class=" form-control-label">CPNJ</label>
                                                <input type="text" id="rg" name="cnpj" placeholder="Informe seu RG" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-8">
                                            <div class="form-group">
